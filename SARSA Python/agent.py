...
class Agent:
    ...
    def __init__(self,pos): 
        ...
        #self.modules.append(module.TargetSeekModule(self)) #target seeking module send agents to target
        self.modules.append(module.ObstacleAvoidanceModule(self)) #obstacle avoidance
